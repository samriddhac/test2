package test.core.core1.api.exception;
...
@ControllerAdvice
public class Core1CoreServiceExceptionHandler extends ResponseEntityExceptionHandler {
  private static final Logger LOG = LoggerFactory.getLogger(Core1CoreServiceExceptionHandler.class);
