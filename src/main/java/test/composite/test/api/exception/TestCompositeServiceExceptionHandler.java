package test.composite.test.api.exception;
...
@ControllerAdvice
public class TestCompositeServiceExceptionHandler extends ResponseEntityExceptionHandler {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestCompositeServiceExceptionHandler.class);
